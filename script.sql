...
EXCERPT_ID				BIGINT UNSIGNED		UNIQUE	AUTO_INCREMENT,
...
CREATE PROCEDURE PRC_STORE_EXCERPT (IN UID BIGINT UNSIGNED, IN WID BIGINT UNSIGNED, IN WCOUNT INT, IN PHRASE VARCHAR(150))
	BEGIN
		INSERT INTO EXCERPT (SITE_ID, WORD_ID, EXCERPT_WRD_AMT_SITE, EXCERPT_PHRASE) 
			VALUES(UID, WID, WCOUNT, PHRASE);
	END |
